            ...
            <div id="group-pricing" class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition-transform">
                    <div class="p-8">
                        ...
                        <a href="<?php echo e(url('/sign-up')); ?>" class="block text-center bg-forward-orange hover:bg-orange-600 text-white font-semibold py-3 px-6 rounded-full transition-colors">
                            Get Started
                        </a>
                    </div>
                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/pricing.blade.php ENDPATH**/ ?>
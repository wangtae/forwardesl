        ...
        <div class="container max-w-7xl mx-auto px-4 py-16 lg:py-24">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="text-white order-2 lg:order-1">
                    ...
                    <a href="<?php echo e(url('/sign-up')); ?>" class="inline-block bg-forward-blue hover:bg-blue-700 text-white font-semibold px-8 py-3 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg">
                        Get Started
                    </a>
                </div>
                ...
                <div class="relative order-1 lg:order-2">
                    <div class="grid grid-cols-2 gap-4">
                        <div class="space-y-4">
                            <?php if(file_exists(public_path("images/hero/student-1.png"))): ?>
                                <img src="<?php echo e(asset('images/hero/student-1.png')); ?>" alt="Student 1" class="rounded-lg shadow-lg w-full hover-lift">
                            <?php else: ?>
                                <div class="bg-gray-200 rounded-lg aspect-square flex items-center justify-center">
                                    <span class="text-gray-500">Student 1</span>
                                </div>
                            <?php endif; ?>
                            <?php if(file_exists(public_path("images/hero/student-2.png"))): ?>
                                <img src="<?php echo e(asset('images/hero/student-2.png')); ?>" alt="Student 2" class="rounded-lg shadow-lg w-full hover-lift">
                            <?php else: ?>
                                <div class="bg-gray-200 rounded-lg aspect-square flex items-center justify-center">
                        ...
                        <div class="space-y-4 mt-8">
                            <?php if(file_exists(public_path("images/hero/student-3.png"))): ?>
                                <img src="<?php echo e(asset('images/hero/student-3.png')); ?>" alt="Student 3" class="rounded-lg shadow-lg w-full hover-lift">
                            <?php else: ?>
                                <div class="bg-gray-200 rounded-lg aspect-square flex items-center justify-center">
                                    <span class="text-gray-500">Student 3</span>
                                </div>
                            <?php endif; ?>
                            <?php if(file_exists(public_path("images/hero/student-4.png"))): ?>
                                <img src="<?php echo e(asset('images/hero/student-4.png')); ?>" alt="Student 4" class="rounded-lg shadow-lg w-full hover-lift">
                            <?php else: ?>
                                <div class="bg-gray-200 rounded-lg aspect-square flex items-center justify-center">
                ...
                <div class="swiper-wrapper">
                    <?php for($i = 1; $i <= 12; $i++): ?>
                        <div class="swiper-slide">
                            <?php if(file_exists(public_path("images/students/student-{$i}.jpg"))): ?>
                                <img src="<?php echo e(asset("images/students/student-{$i}.jpg")); ?>" alt="Student" class="w-full h-auto rounded-lg shadow-md">
                            <?php else: ?>
    ...
    <section class="bg-gray-50 py-16">
        <div class="container max-w-7xl mx-auto px-4">
            ...
            <div class="flex flex-wrap justify-center items-center gap-8" data-aos="fade-up" data-aos-delay="200">
                <?php $__currentLoopData = ['witesol', 'tesol', 'cert1', 'cert2', 'cert3', 'cert4']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(file_exists(public_path("images/certificates/{$cert}.png"))): ?>
                        <img src="<?php echo e(asset("images/certificates/{$cert}.png")); ?>" alt="<?php echo e(ucfirst($cert)); ?>" class="h-20 w-auto grayscale hover:grayscale-0 transition-all hover-lift">
                    <?php endif; ?>

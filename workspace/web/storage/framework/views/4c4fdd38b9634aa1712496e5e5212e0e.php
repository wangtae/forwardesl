<?php $__env->startSection('title', 'Children - Forward ESL'); ?>
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="text-center">
                    ...
                    <div class="flex justify-center space-x-4">
                        <a href="<?php echo e(url('/sign-up')); ?>" class="bg-forward-orange hover:bg-orange-600 text-white font-semibold px-8 py-4 rounded-full transition-all">
                            1 Child
                        </a>
                        <a href="<?php echo e(url('/sign-up')); ?>" class="bg-forward-blue hover:bg-blue-800 text-white font-semibold px-8 py-4 rounded-full transition-all">
                            2 Children
                        </a>
                        <a href="<?php echo e(url('/sign-up')); ?>" class="bg-green-600 hover:bg-green-700 text-white font-semibold px-8 py-4 rounded-full transition-all">
                            3+ Children
                        </a>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/children.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="container max-w-7xl mx-auto px-4">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="text-white" data-aos="fade-right" data-aos-delay="100">
                    ...
                    <a href="<?php echo e(url('/sign-up')); ?>" class="inline-block bg-forward-blue hover:bg-blue-800 text-white font-semibold px-8 py-4 rounded-full transition-all duration-300 transform hover:scale-105 animate-pulse-slow">
                        Get Started
                    </a>
                </div>
                        ...
                        <div class="swiper-wrapper">
                            <?php for($i = 1; $i <= 5; $i++): ?>
                                <div class="swiper-slide">
                                    <?php if(file_exists(public_path("images/hero/student-{$i}.jpg"))): ?>
                                        <img src="<?php echo e(asset("images/hero/student-{$i}.jpg")); ?>" alt="Forward ESL Student" class="w-full h-auto">
                                    <?php else: ?>
                                        <img src="https://via.placeholder.com/600x400/FFA557/ffffff?text=Student+<?php echo e($i); ?>" alt="Forward ESL Student <?php echo e($i); ?>" class="w-full h-auto">
                                    <?php endif; ?>
                                </div>
                            <?php endfor; ?>
                        </div>
    ...
    <section class="bg-forward-dark text-white py-12 parallax" style="background-image: linear-gradient(rgba(0,0,0,0.8), rgba(0,0,0,0.8)), url('<?php echo e(asset('images/stats-bg.jpg')); ?>');">
